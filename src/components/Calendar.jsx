...
import {ChevronLeftIcon, ChevronDownIcon, ChevronRightIcon, DocumentIcon, ClockIcon} from "@heroicons/react/24/outline";
...
export default function Calendarr() {
    // ... your state and useEffect to fetch data
...
//                     <time dateTime="2022-01">{months[localDate.getMonth()]} - {new Date().getFullYear()}</time>
//                 </h1>
